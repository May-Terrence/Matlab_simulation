...
%         for u = 0 : delta : 1 - delta
    ...
    elseif i == 3
        ...
        % for u = 0 : 0.001 : 1-0.001
        for u = nodeVector(3) : 0.001 : nodeVector(6)
            for j = 0 : 1 : n
                Bik(j+1, 1) = BaseFunction(j, k-1 , u, nodeVector);
            end
            p_u = P * Bik;
...
% % plot(path_Quasi_Uniform_BSpline(:,1),path_Quasi_Uniform_BSpline(:,2),'ro', 'MarkerSize', 5)
