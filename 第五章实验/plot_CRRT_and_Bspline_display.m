...
h = legend('\fontname{宋体}起点', '\fontname{宋体}目标点','\fontname{宋体}障碍物', ...
    '\fontname{宋体}初始折线路径', ...
    '\fontname{Times New Roman}B\fontname{宋体}样条平滑后的路径');
...
% 设置坐标轴字号
set(ax, 'FontSize', 7); 
annotation('textarrow', [0.375, 0.46], [0.56, 0.42], 'FontSize', 10);
...
fig.Position = [5 10 15 7]; 
% fimename = 'D:\Flycontrol\SCUT_thesis\Fig\chapter5\B样条曲线平滑折线路径结果.pdf';
% PlotToFileColorPDF(RRTC,fimename,15,7);