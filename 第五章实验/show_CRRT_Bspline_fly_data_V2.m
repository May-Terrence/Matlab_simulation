...
Rol = figure;   %角度
ax1 = subplot(2, 1, 1);
plot(x, Xd, 'Color',[0 0 0.800], 'LineWidth', 0.75);grid on;hold on;
plot(x, X, '--','Color',[0.800 0 0], 'LineWidth', 0.75);grid on;hold on;
% axis([0 30 0 70]);
xlim([0 26]);
...
ax2 = subplot(2, 1, 2);
plot(x, Yd, 'Color',[0 0 0.800], 'LineWidth', 0.75);grid on;hold on;
plot(x, Y, '--','Color',[0.800 0 0], 'LineWidth', 0.75);grid on;hold on;
% axis([0 26 0 50]);
xlim([0 26]);
...
h = legend('\fontname{宋体}参考值\fontname{Times New Roman}(\fontname{宋体}给定值\fontname{Times New Roman})', '\fontname{宋体}实际值');
h.ItemTokenSize(1) = 15;
h.Position = [0.2, 0.90, 0.6, 0.1];
set(h,'NumColumns',4,'Box','off');
set(ax1, 'Position', [0.1, 0.6, 0.8, 0.28]); % 第一个子图
set(ax2, 'Position', [0.1, 0.15, 0.8, 0.28]); % 第二个子图

fig = gcf;
fig.Units = 'centimeters';
fig.Position = [0 0 16 6.8]; 
fimename = 'D:\Flycontrol\SCUT_thesis\Fig\chapter5\位置曲线规划与跟踪结果_V2.pdf';
PlotToFileColorPDF(Rol,fimename,16,6.8);

%%
Vel = figure;   
ax1 = subplot(2, 1, 1);
plot(x, v_Ref(1,:), 'Color',[0 0 0.800], 'LineWidth', 0.75);grid on;hold on;
plot(x, vxReal, 'c', 'LineWidth', 0.75);grid on;hold on;
plot(x, v_Fdb(:,1), '--','Color',[0.800 0 0], 'LineWidth', 0.75);grid on;hold on;
% axis([0 5.5 -13 13]);
xlim([0 26]);
...
ax2 = subplot(2, 1, 2);
p1 = plot(x, v_Ref(2,:), 'Color',[0 0 0.800], 'LineWidth', 0.75);grid on;hold on;
p2 = plot(x, vyReal, 'c', 'LineWidth', 0.75);grid on;hold on;
p3 = plot(x, v_Fdb(:,2), '--','Color',[0.800 0 0], 'LineWidth', 0.75);grid on;hold on;
% axis([0 5.5 -13 13]);
xlim([0 26]);
...
fig.Units = 'centimeters';
fig.Position = [0 0 16 6.8]; 
fimename = 'D:\Flycontrol\SCUT_thesis\Fig\chapter5\速度曲线规划与跟踪结果_V2.pdf';
PlotToFileColorPDF(Vel,fimename,16,6.8);
...
plot(x, accSet(1,:), 'Color',[0 0 0.800], 'LineWidth', 0.75);grid on;hold on;
plot(x, accReal(1,:), 'c', 'LineWidth', 0.75);grid on;hold on;
plot(x, Acc_Fdb(1,:), '--','Color',[0.800 0 0], 'LineWidth', 0.75);grid on;hold on;
xlim([0 26]);
% axis([0 120 -7 7]);
...
ax2 = subplot(2, 1, 2);
plot(x, accSet(2,:), 'Color',[0 0 0.800], 'LineWidth', 0.75);grid on;hold on;
plot(x, accReal(2,:), 'c', 'LineWidth', 0.75);grid on;hold on;
plot(x, Acc_Fdb(2,:), '--','Color',[0.800 0 0], 'LineWidth', 0.75);grid on;hold on;
% axis([0 5.5 -13 13]);
xlim([0 26]);
...
fig.Units = 'centimeters';
fig.Position = [0 0 16 6.8]; 
fimename = 'D:\Flycontrol\SCUT_thesis\Fig\chapter5\加速度曲线规划与跟踪结果_V2.pdf';
PlotToFileColorPDF(Ruler,fimename,16,6.8);


%%
attitude = figure;   %角度
ax1 = subplot(3, 1, 1);
plot(x, Rolld*r2d, 'Color',[0 0 0.800], 'LineWidth', 0.75);grid on;hold on;
plot(x, Roll*r2d, '--','Color',[0.800 0 0], 'LineWidth', 0.75);grid on;hold on;
xlim([0 26]);
ylabel('\fontname{宋体}滚转角\fontname{Times New Roman}(°)');
xlabel('\fontname{宋体}时间\fontname{Times New Roman}(s)');
set(attitude.CurrentAxes, 'FontSize', 10,'FontName','Times New Roman','LabelFontSizeMultiplier', 1,'TitleFontSizeMultiplier',1,'LineWidth',0.5,'Xcolor','black','Ycolor','black','Zcolor','black')

ax2 = subplot(3, 1, 2);
plot(x, Pitchd*r2d, 'Color',[0 0 0.800], 'LineWidth', 0.75);grid on;hold on;
plot(x, Pitch*r2d, '--','Color',[0.800 0 0], 'LineWidth', 0.75);grid on;hold on;
xlim([0 26]);
...
ax3 = subplot(3, 1, 3);
plot(x, Yawd*r2d, 'Color',[0 0 0.800], 'LineWidth', 0.75);grid on;hold on;
plot(x, Yaw*r2d, '--','Color',[0.800 0 0], 'LineWidth', 0.75);grid on;hold on;
xlim([0 26]);
...
fimename = 'D:\Flycontrol\SCUT_thesis\Fig\chapter5\姿态跟踪结果_V2.pdf';
PlotToFileColorPDF(attitude,fimename,16,10);
