...
plot(x, pidRol1*r2d, 'LineWidth', 0.75);grid on;hold on;
plot(x, pidRol2*r2d, 'LineWidth', 0.75);grid on;hold on;
plot(x, pidRol3*r2d, 'LineWidth', 0.75);grid on;hold on;
plot(x, pidRol4*r2d, 'LineWidth', 0.75);grid on;hold on;
plot(x, pidRol5*r2d, 'LineWidth', 0.75);grid on;hold on;
...
% h = legend('\fontname{宋体}参考值', 'd=0.01', 'd=0.1','d=0.3','d=0.6','d=1');
h = legend('\fontname{宋体}参考值', 'd=0', 'd=0.1','d=0.5','d=1','d=3');
h.ItemTokenSize(1) = 20;
set(h,'NumColumns',10,'location','northoutside','Box','off');
...
plot(x, pidPit1*r2d, 'LineWidth', 0.75);grid on;hold on;
plot(x, pidPit2*r2d, 'LineWidth', 0.75);grid on;hold on;
plot(x, pidPit3*r2d, 'LineWidth', 0.75);grid on;hold on;
plot(x, pidPit4*r2d, 'LineWidth', 0.75);grid on;hold on;
plot(x, pidPit5*r2d, 'LineWidth', 0.75);grid on;hold on;
% axis([0 5.5 -8 8]);
axis([0 5.5 -1 1]);
...
plot(x, pidYaw1*r2d, 'LineWidth', 0.75);grid on;hold on;
plot(x, pidYaw2*r2d, 'LineWidth', 0.75);grid on;hold on;
plot(x, pidYaw3*r2d, 'LineWidth', 0.75);grid on;hold on;
plot(x, pidYaw4*r2d, 'LineWidth', 0.75);grid on;hold on;
plot(x, pidYaw5*r2d, 'LineWidth', 0.75);grid on;hold on;
% axis([0 5.5 -8 10]);
% axis([0 5.5 -8 15]);
% axis([0 5.5 -1 1]);
axis([0 5.5 -2 2]);
